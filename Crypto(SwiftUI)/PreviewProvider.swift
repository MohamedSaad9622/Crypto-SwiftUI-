...
class DeveloperPreview {
    ...
    let state1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.0)
    let state2 = StatisticModel(title: "Total volume", value: "$1.3Tr")
    let state3 = StatisticModel(title: "Portofolio Value", value: "$50.4k", percentageChange: -12.34)
